...
void setupGetItInjector() {
  ...
  getIt.registerFactory<PokemonDetailsViewModel>(
    () => PokemonDetailsViewModel(getIt<PokemonRepositoryInterface>()),
  );
}
